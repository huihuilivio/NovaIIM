...
inline constexpr std::string_view get_alias_struct_name(UserDevice*) { return "user_devices"; }
...
inline constexpr std::string_view get_alias_struct_name(Message*) { return "messages"; }
...
inline constexpr std::string_view get_alias_struct_name(Conversation*) { return "conversations"; }
...
inline constexpr std::string_view get_alias_struct_name(ConversationMember*) { return "conversation_members"; }
...
inline constexpr std::string_view get_alias_struct_name(AuditLog*) { return "audit_logs"; }
...
inline constexpr std::string_view get_alias_struct_name(AdminSession*) { return "admin_sessions"; }
...
inline constexpr std::string_view get_alias_struct_name(Role*) { return "roles"; }
...
inline constexpr std::string_view get_alias_struct_name(Permission*) { return "permissions"; }
